...
pdfinfo=pdfinfo_from_path(pdf_file, userpw=None,poppler_path=r'C:\Program Files\poppler-23.08.0\Library\bin')
...
for page in range(1, maxPages+1,10):
    ...
    images = convert_from_path(pdf_file, poppler_path=r'C:\Program Files\poppler-23.08.0\Library\bin', dpi=200, first_page=page, last_page= min(page+10-1,maxPages))            
